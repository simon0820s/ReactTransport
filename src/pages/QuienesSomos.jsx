...
export default function QuienesSomos() {
  return (
    <section
      id="quienes_somos"
      className="h-screen flex flex-col items-center justify-center bg-orange-800 bg-opacity-20"
    >
      <div className="flex flex-col justify-center sm:justify-start h-4/5 bg-neutral-100 shadow-lg shadow-gray-500">
