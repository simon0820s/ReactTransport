  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center sm:justify-start bg-neutral-100 w-full h-2/4 rounded-b-full">
        <div className="flex flex-col items-center gap-1 sm:gap-4 px-16 mt-2 sm:mt-20">
          <h2 className="text-[#2f4a69] font-bold text-xl sm:text-3xl underline">Unete!</h2>
      ...
      <WiMoonAltWaxingCrescent5 className="text-7xl sm:text-9xl mt-20 text-[#2f4a69] "/>
    </section>
  );
}
